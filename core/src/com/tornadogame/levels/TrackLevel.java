...
public class TrackLevel extends Level {
	
	public TrackLevel(OrthographicCamera camera, float endOfLevel, int level) {
		super(camera, LevelHandler.LEVEL_TRACK, endOfLevel);
	...
	public void update(LevelHandler levelHandler, OrthographicCamera camera, TornadoGame tornadoGame) {
		...
		/*if (TornadoGame.displayWinningScreen) {
			tornadoGame.getWinningScreen().update();
		}*/
	}
